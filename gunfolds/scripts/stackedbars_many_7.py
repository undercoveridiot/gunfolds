...
if __name__ == '__main__':
    ...
    l = [(0.20, 'leibnitz_nodes_7_density_0.2_rasl_singlecore_async_.zkl'),
         (0.25, 'leibnitz_nodes_7_density_0.25_rasl_singlecore_async_.zkl'),
         (0.30, 'leibnitz_nodes_7_density_0.3_rasl_singlecore_async_.zkl')]
