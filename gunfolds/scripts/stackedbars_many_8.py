...
if __name__ == '__main__':
    ...
    l = [(0.15, 'leibnitz_nodes_8_density_0.15_rasl_singlecore_async_.zkl'),
         (0.20, 'leibnitz_nodes_8_density_0.2_rasl_singlecore_async_.zkl'),
         (0.25, 'leibnitz_nodes_8_density_0.25_rasl_singlecore_async_.zkl'),
         (0.30, 'oranos_nodes_8_density_0.3_rasl_singlecore_async_.zkl')]

    fig = pl.figure(figsize=[4.6, 2.25])
    # Read in data & create total column

    densities = [0.15, .20, .25]
    d = {}
    for fname in l:
